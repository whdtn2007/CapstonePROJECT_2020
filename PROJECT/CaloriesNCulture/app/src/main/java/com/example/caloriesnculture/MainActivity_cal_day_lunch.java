...
public class MainActivity_cal_day_lunch extends AppCompatActivity {
    ...
    List<String> list_calday_listView_lunch;
    ArrayAdapter<String> adapter_calday_listView_lunch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_calday_listView_lunch = new ArrayList<String>();
        adapter_calday_listView_lunch = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, list_calday_listView_lunch);
        calday_listView_lunch.setAdapter(adapter_calday_listView_lunch);
        ...
        calday_listView_lunch.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView,
                ...
                //클릭한 아이템의 문자열을 가져옴
                lunch_item = (String) adapterView.getItemAtPosition(position);
                ...
                alert_confirm.setMessage("어떤작업을 수행하실건가요?").setCancelable(false).setPositiveButton("수정",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                pref=getSharedPreferences("staticFILE",MODE_PRIVATE);
                                editor=pref.edit();
                                editor.putString("foodname_l_edit",lunch_item);
                                editor.commit();
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    String result = new CustomTask().execute("lunch_del", nickdata, day,lunch_item).get();
                                    ...
                                    if (result.equals("ok")) {
                                        ...
                                        try {
                                            ...
                                            list_calday_listView_lunch.clear();
                                            if (result.equals("ok")) {
                                                Toast.makeText(MainActivity_cal_day_lunch.this, result2 + "연결ok", Toast.LENGTH_SHORT).show();
                                                list_calday_listView_lunch.add(0, "데이터가 없습니다");
                                                adapter_calday_listView_lunch.notifyDataSetChanged();
                                            } else {
                                                Toast.makeText(MainActivity_cal_day_lunch.this, result2 + "연결ok", Toast.LENGTH_SHORT).show();
                                                ...
                                                for (int i = 0; i < n; i++) {
                                                    list_calday_listView_lunch.add(i, array[i]);
                                                }
    ...
    class CustomTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                String str;
                URL url = new URL("http://106.241.33.158:1080/SelectLunch.jsp");//바꿔주세요//"http://192.168.56.1:8080/Cap_Connection_2/join_pra.jsp"
